...
namespace RPG_Game.Systems
{
	public class SchedulingSystem
	{
		...
		//Add a new object to the schedule and place it at the current time plus the object's Time property
		...
		//Removes a monster after it is killed and before its action can come up again
		...
		//Get the next object whose turn it is on the schedule and advance if necessary
		...
		//Get the current turn for the schedule
		public int GetTime()
		{
			return _time;
		}
